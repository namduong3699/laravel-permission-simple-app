...
class Permission extends Model implements PermissionContract
{
    ...
    {
        //Operator '??' in PHP:
        //Example: $fruit = $f ?? 'apple';
        //$fruit = $f if $f is exist or has value is not null 
        $attributes['guard_name'] = $attributes['guard_name'] ?? config('auth.defaults.guard');

        parent::__construct($attributes);

        //Set model table to table which defined in config/permission
    ...
    public static function create(array $attributes = [])
    {
        ...
        //getPermission in PermissionRegistar: 
    ...
    /**
     * A permission can be applied to roles, ex: Admin and user can see a post
     * Get roles which permission applied to
     */
